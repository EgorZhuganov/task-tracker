...
public class InMemoryTasksManagerV01 implements TaskManager {

    protected Map<UUID, Epic> epicMap;
    protected List<SingleTask> singleTaskList;
    protected HistoryManager inMemoryHistoryManager;

    public InMemoryTasksManagerV01() {
